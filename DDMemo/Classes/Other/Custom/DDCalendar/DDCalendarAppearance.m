...
@implementation DDCalendarAppearance
+ (instancetype)share{
    static dispatch_once_t onceToken;
    static DDCalendarAppearance *appearance;
    dispatch_once(&onceToken, ^{
        appearance = [DDCalendarAppearance new];
    });
    return  appearance;
}
...
- (void)setDefaultValues{
    ...
    self.weekDayFormat = DDCalendarWeekDayFormatSingle;
